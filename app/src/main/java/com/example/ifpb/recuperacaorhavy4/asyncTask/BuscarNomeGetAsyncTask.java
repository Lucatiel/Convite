package com.example.ifpb.recuperacaorhavy4.asyncTask;

import android.os.AsyncTask;
import android.util.Log;

import com.example.ifpb.recuperacaorhavy4.util.BuscarPessoaCallBack;
import com.example.ifpb.recuperacaorhavy4.util.HttpService;
import com.example.ifpb.recuperacaorhavy4.entidade.Pessoa;
import com.example.ifpb.recuperacaorhavy4.util.Response;
...
public class BuscarNomeGetAsyncTask extends AsyncTask<Pessoa, Void, Response>{
    ...
    public BuscarNomeGetAsyncTask (BuscarPessoaCallBack buscarNomeCallBack) {
